...
SIDE_EFFECT_HINTS = {'downstream_effects': [], 'related_docs': ['vendor_agreement', 'service_level_record', 'partner_issue_case'], 'action_targets': {'create': None, 'assign': 'in_review', 'review': 'in_review', 'amend': None, 'renew': 'renewed', 'close': 'closed', 'archive': 'archived'}, 'action_side_effects_file': 'side_effects.json'}
