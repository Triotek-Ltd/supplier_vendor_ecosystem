"""Action handler seed for contract_review_case:renew."""
...
ACTION_ID = "renew"
ACTION_RULE: dict[str, Any] = {'allowed_in_states': ['opened', 'in_review', 'renewed', 'amended'], 'transitions_to': 'renewed'}
