"""Action handler seed for contract_review_case:amend."""
...
ACTION_ID = "amend"
ACTION_RULE: dict[str, Any] = {'allowed_in_states': ['opened', 'in_review', 'renewed', 'amended'], 'transitions_to': None}
