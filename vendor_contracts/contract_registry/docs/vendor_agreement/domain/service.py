...
SIDE_EFFECT_HINTS = {'downstream_effects': [], 'related_docs': ['service_level_record', 'contract_review_case', 'vendor_contract'], 'action_targets': {'create': None, 'review': None, 'approve': 'approved', 'activate': 'active', 'renew': 'renewed', 'archive': 'archived'}, 'action_side_effects_file': 'side_effects.json'}
