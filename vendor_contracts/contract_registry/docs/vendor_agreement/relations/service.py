"""Relation service seed for vendor_agreement."""
...
RELATED_DOCS = [{'doc_id': 'service_level_record', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'contract_review_case', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'vendor_contract', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'party_record', 'relation_type': 'related', 'show_in_related_panel': True}]
FETCH_RULES = [{'source_field': 'party', 'doc_id': 'party_record', 'mode': 'context'}]

BORROWED_FIELDS = [{'description': 'supplier identity'}, {'description': 'capability context from supplier_capability_profile'}, {'field_id': 'party', 'doc_id': 'party_record', 'description': 'Borrow context from party_record through party.'}]
