"""Relation service seed for service_level_record."""
...
RELATED_DOCS = [{'doc_id': 'vendor_agreement', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'contract_review_case', 'relation_type': 'related', 'show_in_related_panel': True}, {'doc_id': 'vendor_review', 'relation_type': 'related', 'show_in_related_panel': True}]
FETCH_RULES = []

BORROWED_FIELDS = [{'description': 'SLA targets'}, {'description': 'vendor identity from vendor_agreement'}]
