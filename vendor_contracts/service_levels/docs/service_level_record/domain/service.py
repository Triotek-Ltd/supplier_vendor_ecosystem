...
SIDE_EFFECT_HINTS = {'downstream_effects': [], 'related_docs': ['vendor_agreement', 'contract_review_case', 'vendor_review'], 'action_targets': {'record': None, 'review': 'reviewed', 'archive': 'archived'}, 'action_side_effects_file': 'side_effects.json'}
