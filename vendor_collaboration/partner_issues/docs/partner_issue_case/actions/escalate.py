"""Action handler seed for partner_issue_case:escalate."""
...
ACTION_ID = "escalate"
ACTION_RULE: dict[str, Any] = {'allowed_in_states': ['opened', 'triaged', 'in_progress', 'resolved', 'escalated'], 'transitions_to': 'escalated'}
