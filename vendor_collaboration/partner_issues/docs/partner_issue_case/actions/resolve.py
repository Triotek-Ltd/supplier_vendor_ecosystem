"""Action handler seed for partner_issue_case:resolve."""
...
ACTION_ID = "resolve"
ACTION_RULE: dict[str, Any] = {'allowed_in_states': ['opened', 'triaged', 'in_progress', 'resolved', 'escalated'], 'transitions_to': 'resolved'}
