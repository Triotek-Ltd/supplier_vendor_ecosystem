...
SIDE_EFFECT_HINTS = {'downstream_effects': [], 'related_docs': ['supplier_onboarding_case', 'supplier_capability_profile', 'vendor_review'], 'action_targets': {'create': None, 'review': None, 'renew': None, 'expire': None, 'archive': 'archived'}, 'action_side_effects_file': 'side_effects.json'}
