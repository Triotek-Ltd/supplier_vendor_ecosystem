"""Action handler seed for supplier_onboarding_case:reject."""
...
ACTION_ID = "reject"
ACTION_RULE: dict[str, Any] = {'allowed_in_states': ['opened', 'in_review', 'approved', 'rejected'], 'transitions_to': 'rejected'}
