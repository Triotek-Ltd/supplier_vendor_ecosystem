"""Action handler seed for supplier_onboarding_case:create."""
...
ACTION_ID = "create"
ACTION_RULE: dict[str, Any] = {'allowed_in_states': ['opened', 'in_review', 'approved', 'rejected'], 'transitions_to': None}
